...
class CompanyApi {
  ...
  Future<int> obtenerCompanyById(String idCompany) async {
    try {
      final response = await http.post(Uri.parse("$API_BASE_URL/api/Negocio/listar_negocio_por_id"), body: {'id_company': idCompany});
  ...
  Future<int> obtenerSucursalesByCompany(String idCompany) async {
    try {
      final response = await http.post(Uri.parse("$API_BASE_URL/api/Negocio/listar_sedes_por_negocio"), body: {'id_negocio': idCompany});
  ...
  Future<int> obtenerSucursalesByIdSubsidiary(String idSubsidiary) async {
    try {
      final response = await http.post(Uri.parse("$API_BASE_URL/api/Negocio/listar_sucursal_por_id"), body: {'id_sucursal': idSubsidiary});
